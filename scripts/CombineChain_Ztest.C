...
int foo() {
  ...
  TFile * f1_n1 = new TFile("/home/cjdavis62/Majoron/Ztest_2nu_Z52.root");
  TFile * f2_n2 = new TFile("/home/cjdavis62/Majoron/Ztest_2nu_Z54.root");
